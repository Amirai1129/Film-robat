...
async def gen_link_s(bot, message):
    ...
    try:
        ...
        print("🔍 Unpack Output:", result)  # چاپ مقدار برای لاگ
...
async def gen_link_batch(bot, message):
    ...
    try:
        ...
        return await message.reply('⚠️ This may be a private channel/group. Make me an admin there.')
    except (UsernameInvalid, UsernameNotModified):
        return await message.reply('⚠️ Invalid link specified.')
    except Exception as e:
        return await message.reply(f'⚠️ Error: {e}')

    sts = await message.reply("⏳ Generating link. This may take some time...")
